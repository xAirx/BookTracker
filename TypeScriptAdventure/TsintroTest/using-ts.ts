...
const input1 = document.getElementById('num1')! as HTMLInputElement; // adding the exclamationmark here tells us via TS that it will never yield null, we can do  this
